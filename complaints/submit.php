<?php
// complaints/submit.php - Complete Complaint Submission
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="../dashboard/student.php" class="list-group-item list-group-item-action">🏠 Dashboard</a>
                        <a href="submit.php" class="list-group-item list-group-item-action active">📝 Submit Complaint</a>
                        <a href="view.php" class="list-group-item list-group-item-action">📋 My Complaints</a>
                        <a href="../lost_found/view.php" class="list-group-item list-group-item-action">🔍 Lost & Found</a>
                        <a href="../lost_found/report.php" class="list-group-item list-group-item-action">📦 Report Item</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="mb-0 text-muted">Report any issue you're facing on campus</p>
                    </div>
                    <div class="card-body">
                        <?php echo $message; ?>
                        ...
                        <form method="POST" action="" id="complaintForm">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="../dashboard/student.php" class="btn btn-outline-secondary">↩️ Back to Dashboard</a>
                            </div>
                        </form>
                    </div>
                </div>
